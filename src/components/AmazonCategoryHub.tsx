...
const getCategoryDescription = (id: string) => {
  switch (id) {
    ...
    case 'men-women': return 'Formal wear, designer footwear, handbags & cosmetic kits.';
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12" id="amazon-category-hub">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-3.5">
        ...
        <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-slate-50 tracking-tight leading-tight">
          Browse Olimart <span className="text-orange-600 dark:text-orange-500 underline decoration-wavy decoration-[#f68b1e]/40">Departments</span>
        </h2>
      ...
      <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-xl grid grid-cols-1 md:grid-cols-3 gap-6 relative overflow-hidden">
        ...
        <div className="flex items-start gap-4 text-left">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-400 leading-relaxed font-medium">
              We leverage real-time delivery channels to dispatch your order with verified Boda Boda riders in Kampala within 2–5 hours.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 text-left">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-400 leading-relaxed font-medium">
              Olimart works closely with UNBS and registered local manufacturers to source genuine consumer items, with zero tolerance for counterfeits.
            </p>
          </div>
        </div>
      </div>
